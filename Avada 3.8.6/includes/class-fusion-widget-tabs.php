					...
					<?php if ( 'true' == $show_comments ) : ?>
						...
						<div id="tab-comments" class="tab tab_content" style="display: none;">
							...
							<!-- Including Viasocial | Facebook Recent comments for WordPress (Avada 3.8.6) | Project by Viaprestige Web Agency | https://github.com/Viaprestige -->	
								<?php if( ( Avada()->settings->get( 'blog_comments' ) && get_post_meta($post->ID, 'pyre_post_comments', true ) != 'yes' ) ||
										  ( ! Avada()->settings->get( 'blog_comments' ) && get_post_meta($post->ID, 'pyre_post_comments', true) == 'no' ) ): ?>
											<?php
											global $wpdb;
								...
								$viasocial = new Facebook();
								$comment_count 	= $viasocial->count('commentsCount'); ?>
